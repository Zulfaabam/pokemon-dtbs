...
// Fetch data
$pokemon = mysqli_query($link, "SELECT * FROM pokemon WHERE is_delete=0 ORDER BY pokemon_id DESC");
$type = mysqli_query($link, "SELECT * FROM  type  WHERE is_delete=0 ORDER BY type_id DESC");
$breeding = mysqli_query($link, "SELECT * FROM  breeding  WHERE is_delete=0 ORDER BY egg_groups_id DESC");
        ...
        <table border="1px">
            ...
            <?php
                ...
                while($item = mysqli_fetch_array($pokemon)) {
                    ...
                    // echo "<td><a href='editPokemon.php?id=$item[pokemon_id]'>Edit</a> | <a href='deletePokemon.php?id=$item[pokemon_id]'>Delete</a></td></tr>";
                }
            ?>
        </table>
    </div>
        ...
        <table border="1px">
            ...
            <?php
                ...
                while($item = mysqli_fetch_array($type)) {
                    ...
                    // echo "<td><a href='editType.php?id=$item[type_id]'>Edit</a> | <a href='deleteType.php?id=$item[type_id]'>Delete</a></td></tr>";
                }
            ?>
        </table>
    </div>
        ...
        <table border="1px">
            ...
            <?php
                ...
                while($item = mysqli_fetch_array($breeding)) {
                    ...
                    // echo "<td><a href='editBreeding.php?id=$item[egg_groups_id]'>Edit</a> | <a href='deleteBreeding.php?id=$item[egg_groups_id]'>Delete</a></td></tr>";
                }
            ?>
        </table>
    </div>
        ...
        <table border="1px">
            ...
            <?php
                while($item = mysqli_fetch_array($pokemonJoin)) { 
                    ...
                    echo "<td>".$item['type_name']."</td>"; 
                    echo "<td>".$item['egg_groups']."</td>"; 
                    // echo "<td><a href='deleteJoin.php?id=$item[pokemon_id]'>Delete</a></td></tr>";
                }   
            ?>
        </table>
    </div>
